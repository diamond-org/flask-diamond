# -*- coding: utf-8 -*-
#
# Flask-Diamond documentation build configuration file, created by
...
from flask_diamond import __version__
...
project = u'Flask-Diamond'
copyright = u'Ian Dennis Miller'
...
htmlhelp_basename = 'Flask-Diamonddoc'
